...
local function remove_item(src, Player, name, amount)
     ...
     TriggerClientEvent('lj-inventory:client:ItemBox', src, QBCore.Shared.Items[name], "remove")
end
...
RegisterServerEvent("keep-crafting:server:crafting_is_done", function(data)
     ...
     TriggerClientEvent('lj-inventory:client:ItemBox', src, QBCore.Shared.Items[data.item.item_name], "add")
